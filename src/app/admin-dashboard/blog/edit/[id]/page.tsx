    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          publishDate: blog.publishedAt ? new Date(blog.publishedAt).toISOString().slice(0, 16) : new Date().toISOString().slice(0, 16),
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-white/20">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Edit Post</h1>
              {autoSaving && (
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
                    placeholder="https://www.riverdayspa.com/blog/post-slug"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800 font-mono text-sm"
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full ${formData.metaDescription.length >= 120 && formData.metaDescription.length <= 160
                    ...
                    {formData.metaDescription.length >= 120 && formData.metaDescription.length <= 160 ? 'Good' : 'Update needed'}
                  </span>
                </div>
                <div className="flex items-center justify-between">
