...
const packages = [
  {
    ...
    title: "River Ecstacy",
    price: "₹4499",
    duration: "Massage Time: 60 mins",
    details: ["2x60 Minutes Package", "Surprise Gift"],
  ...
  },
  {
    ...
    title: "River Fantasy",
    price: "₹9499",
    duration: "Massage Time: 140 mins",
    details: ["2x90 Minutes Massage", "2x50 Minutes Body Scrub", "Surprise Gift"],
  ...
  {
    id: "03",
    title: "River Blissful",
    price: "₹13999",
    duration: "Massage Time: 4 hrs",
    details: [
      "2x60 Minutes Package",
      "2x90 Minutes Package",
      "2x45 Minutes Body Scrub",
      "2x45 Minutes Facial",
      "Surprise Gift"
    ],
    color: "from-green-400 to-blue-400",
...
export default function CouplesPackagesPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F8F5F0] via-white to-[#F8F5F0]">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url('images/best-couple-massage-packages-in-chennai.jpg')` }}
        />
        ...
        >
          ...
          >
            Couple Spa & Massage Service Packages
          </motion.p>
        </motion.div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <p className="text-base lg:text-lg text-[#3E3636]/90 max-w-5xl mx-auto">
            We offer various special packages for our range of <Link href="/best-couple-massage-center" className="text-green-600 font-semibold hover:text-green-400 transition-colors">Couple Spa and massage services</Link>. Additionally, we offer customized packages at the branches that you prefer. Get in touch with our representatives to learn more about our seasonal offers.
          </p>
        </motion.div>
        ...
        <div className="text-center mb-12">
          <motion.h1
            ...
            viewport={{ once: true }}
          >
            Get Relax with a Lovable Person
          </motion.h1>
          <motion.div
