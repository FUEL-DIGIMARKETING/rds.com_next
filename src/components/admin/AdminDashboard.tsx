        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <button
              ...
              className="group relative overflow-hidden bg-gradient-to-br from-pink-500 to-purple-600 text-white p-6 rounded-2xl hover:from-pink-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
            >
              <div className="absolute inset-0 bg-white/10 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 skew-x-12" />
              <div className="relative z-10 flex items-center">
                <div className="p-3 bg-white/20 rounded-xl mr-4 group-hover:rotate-12 transition-transform duration-300">
                ...
                <div className="text-left">
                  <h3 className="font-bold text-lg mb-1">App Admin</h3>
                  <p className="text-pink-100 text-sm">Manage mobile app</p>
                </div>
              </div>
            </button>
          </div>
